        ...
        if manage_user:
            if user_middlename_attrib.count(':') > 0:
                (
                    ...
                    user_middlename_part,
                ) = user_middlename_attrib.split(':', 1)
            ...
            if ldap_mode == "ad":
                ...
                if manage_user:
                    requested_attrs.extend(
                        [user_middlename_attrib, user_firstname_attrib, user_lastname_attrib, user_mail_attrib]
                    )
            ...
            if manage_user:
                ...
                try:
                    ...
                    if user_middlename_part is not None:
                        store_user_middlename = user_middlename.split(
                            b' ' if isinstance(user_middlename, bytes) else ' ',
                            1
                        )[user_middlename_part]
                    else:
                ...
                update_or_insert_values = {
                    "middle_name": store_user_middlename,
